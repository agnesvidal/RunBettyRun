package state {
	 ...
	 * instructions for versus game
	 */
	public class HowToVersusState extends DisplayState {
		...
		private var _graphics:HowToVersusGFX;
		...
		// Constructor method
		//----------------------------------------------------------------------
		public function HowToVersusState() {
			super();
		}
		...
		private function updateControls(controls:EvertronControls):void {
			...
			if(Input.keyboard.justPressed(controls.PLAYER_BUTTON_1)) {
				...
				if (btn == 0) {
					Session.application.displayState = new GameState(1);
				} else if (btn == 1) {
