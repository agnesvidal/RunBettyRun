package se.lnu.stickossdk.component.screenkeyboard.command
{
	 ...
	 */
	public class ScreenKeyboardKeyUpCommand extends ScreenKeyboardKeyCommand {
		...
		override public function execute(keyPresenter:ScreenKeyboardKeys):void {
			...
			if (keyPresenter.selectedKey.y < 0) {
				keyPresenter.selectedKey.y = keyPresenter.keys.length - 1;
			}
